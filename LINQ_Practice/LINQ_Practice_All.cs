...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(i => i.PrimaryInstructor.Birthday.Year > 1979 && i.PrimaryInstructor.Birthday.Year < 1990);
        ...
        {
            var doAll = PracticeData[0].Students.All(c => c.FirstName.Contains("e") || c.FirstName.Contains("E")); //Hint: Cohort1 would be PracticeData[0]
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(c => c.PrimaryInstructor.FirstName.Contains("a") || c.PrimaryInstructor.FirstName.Contains("A"));
