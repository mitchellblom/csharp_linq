...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(i => i.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.SelectMany(s => s.Students).ToList();
        ...
        {
            var expected = PracticeData.Select(i => i.PrimaryInstructor.FirstName).ToList();
